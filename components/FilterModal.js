  ...
  return (
    <View style={styles.modalContainer}>
      ...
      <View style={styles.modalContent}>
        ...
        {/* ✅ Updated Apply Filters Button with correct navigation */}
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              ...
              if (serviceType === 'Lunch') {
                navigation.navigate('RestaurantLunch', { selectedMeal: serviceType });
              } else {
                navigation.navigate('Food', { selectedMeal: serviceType });
              }
            }}>
